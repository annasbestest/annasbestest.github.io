...
After the SIM swap is complete (which can take place in a matter of minutes), the attacker can then use your phone number with complete freedom to send or receive SMS and phone calls, and your SIM card in your phone will be rendered inactive.
