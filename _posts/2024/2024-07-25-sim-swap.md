...
Moments later, I received another notification on my phone that someone was attempting to sign into my account, asking whether it was me.
...
Had I been at work or on the way home from work (this was likely the intention of the 5:30 PM timing), I wouldn't have had WiFi and would not have been able to receive the sign-in prompt.

Or if I was using an iPhone instead that didn't have the prompt feature as part of the Android OS.
...
While the Telstra store staff were finalising the new SIM for me and writing notes in their system, I could see their screen and where they were capturing the notes.

I asked if the Telstra customer relationship console had something to indicate that the account had been compromised, and they pointed to some notes that were hidden by their new notes!

With my new SIM set up, I left the store and went home to gather my senses and
