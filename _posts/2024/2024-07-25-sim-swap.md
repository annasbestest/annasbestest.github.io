...
> **A background on SIM-swapping:** An unauthorised SIM-swap attack occurs when an attacker convinces a telco customer service representative (over the phone or in person) that they are _you_, so that they can move _your_ phone service from one physical SIM card (the one in your phone) to another physical SIM.
> 
...
I also had another, longer list of all my online accounts which required their passwords updated and I used that opportunity to move to a different password manager 1Password. While I could have used Google password manager, that was integrated with the Gmail account that was almost taken over, so I didn't think that was a wise security decision.

My new email service is with Fastmail, a company headquartered in Melbourne. It's a paid service, which, after reading about people randomly being locked out of their Google accounts (unrelated to attempted takeovers) and seeing something on Hacker News along the lines of, "...if you're not paying for it, you're not the customer," gives me some peace of mind. I feel reassured knowing that I'd have a better chance of regaining access to my email in the unlikely event of a glitch-induced lockout.

As I wasn't sure what other information the attacker had about me, I subscribed to Equifax's credit and identity monitoring services to montior whether the attacker was also applying for credit using my identity. I continued this for around six months on a monthly subscription until I was comfortable that the dust had settled and the attacker had move on. 
